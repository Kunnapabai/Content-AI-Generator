...
```
["is_a","aka","related_to","has_attribute","has_quantity","has_duration",
 "has_cost","has_benefit","has_risk","requires","time_to_result",
 "compared_with","alternative_to","suitable_for","defined_as","available_at"]
```
...
lexical_signals:
  overused_tokens: ["ultimate guide", "complete guide", "what is", "how to", "tutorial"]
  distinctive_tokens: [framework, prompting, templates, paper, benchmark, code]
  temporal_tokens: [2023, 2024, 2025, latest, updated]
  evidence:
    results: [0]
    paa: [0]
    related: [0]
...
pattern_signals:
  ...
  freshness_cues:
    ...
    update_words: [updated, latest, guide, 2025, new]
    evidence:
      results: [0]
  brand_signals:
